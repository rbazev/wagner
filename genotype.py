...
#        self.graph.draw(filename)
    ...
    def calc_stab_sel_fitness(self, stabilizing_selection_strength):
        D = Development.calculate_equilibrium_steady_state(Development.average_expression_pattern, Development.gene_expression_pattern, Genotype.n_genes) #each of these is precalc in development object
